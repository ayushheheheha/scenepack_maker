// Minimal inline SVG icons (lucide-style) — keeps the app dependency-free and
// matches the flat, decoration-free aesthetic. All use currentColor so callers
...
export function PauseIcon({ size = 18, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
